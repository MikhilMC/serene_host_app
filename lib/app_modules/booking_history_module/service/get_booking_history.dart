...
Future<List<HostBookingHistoryModel>> getBookingHistory() async {
  try {
    ...
    final url = Uri.parse(AppUrls.getBookingHistoryUrl)
    ...
    if (resp.statusCode == 200) {
      ...
      final response = decoded
          .map((item) => HostBookingHistoryModel.fromJson(item))
          .toList();
