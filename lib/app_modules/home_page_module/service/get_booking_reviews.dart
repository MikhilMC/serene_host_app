...
Future<List<BookingReviewModel>> getBookingReviews() async {
  try {
    int userId = 38;
    ...
    final url = Uri.parse(AppUrls.getBookingReviewsUrl)
    ...
    if (resp.statusCode == 200) {
      ...
      final response =
          decoded.map((item) => BookingReviewModel.fromJson(item)).toList();
