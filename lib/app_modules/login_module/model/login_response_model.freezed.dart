...
abstract class $LoginResponseModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String message, int id, String name, String status});
}
...
class _$LoginResponseModelImpl implements _LoginResponseModel {
  ...
  @override
  String toString() {
    return 'LoginResponseModel(message: $message, id: $id, name: $name, status: $status)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, message, id, name, status);
...
abstract class _LoginResponseModel implements LoginResponseModel {
  const factory _LoginResponseModel(
      ...
      required final String status}) = _$LoginResponseModelImpl;
