...
//
//     final hostBookingModel = hostBookingModelFromJson(jsonString);

import 'dart:convert';

List<HostBookingModel> hostBookingModelFromJson(String str) =>
    List<HostBookingModel>.from(
        json.decode(str).map((x) => HostBookingModel.fromJson(x)));

String hostBookingModelToJson(List<HostBookingModel> data) =>
