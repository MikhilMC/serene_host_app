...
mixin _$BookingDetailsState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(BookingDetailsModel hostBooking) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(BookingDetailsModel hostBooking)? success,
...
abstract class _$$BookingDetailsSuccessImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({BookingDetailsModel hostBooking});
}
...
class _$BookingDetailsSuccessImpl implements BookingDetailsSuccess {
  const _$BookingDetailsSuccessImpl(this.hostBooking);

  @override
  final BookingDetailsModel hostBooking;

  @override
  String toString() {
    return 'BookingDetailsState.success(hostBooking: $hostBooking)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return success?.call(hostBooking);
  }
...
abstract class BookingDetailsSuccess implements BookingDetailsState {
  const factory BookingDetailsSuccess(final BookingDetailsModel hostBooking) =
      _$BookingDetailsSuccessImpl;

  BookingDetailsModel get hostBooking;
